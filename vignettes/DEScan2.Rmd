...
```{r eval=TRUE}
bam.files <- list.files(system.file("extdata/bam", package = "DEScan2"), full.names = TRUE)
```
...
regions <- finalRegions(peakSamplesGRangesList=peaksGRL,

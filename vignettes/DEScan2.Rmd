...
peaks.file <- system.file("extdata/peaks/RData/peaksGRL_all_files.rds", package="DEScan2")
peaksGRL <- readRDS(peaks.file)
regionsGR <- finalRegions(peakSamplesGRangesList=peaksGRL, zThreshold=10, minCarriers=4, saveFlag=FALSE, outputFolder=NULL, verbose=FALSE)
head(regionsGR)
```
